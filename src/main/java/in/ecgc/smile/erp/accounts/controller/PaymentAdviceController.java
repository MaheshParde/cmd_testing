...
//	private static final Logger log = LoggerFactory.getLogger(PaymentAdviceController.class);
	...
	public ResponseEntity<Integer> getSeqNo(
			...
			return new ResponseEntity<Integer>(payAdviceService.getAdviceNo(logicalLocCd, sectionCd, fiscalYear), HttpStatus.OK);
	}
	...
	public ResponseEntity<Integer> updateSeqNo(
			...
			return new ResponseEntity<Integer>( payAdviceService.updateSeqNo(logicalLocCd, sectionCd, fiscalYear, adviceNo), HttpStatus.OK);
	}
	...
	public ResponseEntity<Integer> updatePaymentAdvice(@Valid @RequestBody PaymentAdvice payAdvice){
		...
		log.info("Modifies Obj : : "+payAdvice);
