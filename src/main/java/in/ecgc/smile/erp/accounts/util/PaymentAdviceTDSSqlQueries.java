...
public interface PaymentAdviceTDSSqlQueries {
	 ...
	 * +
	 * "tax_deducted=NULL,appr_base_amt=NULL, service_tax_amt=NULL, oth_amt=:otherAmt,taxinfo_flg = :taxInfoFlag,  last_updated_dt = timestamp 'today' where section_cd = :sectionCd  and advice_no = (:adviceNo)::numeric and logical_loc_cd = :logicalLocCd and advice_stat = 'APRV'"
	 * ;
	 */
	...
	public static final String GET_PAYMENT_ADVICE_TDS_DTL =  "select * from accounts.ecgc_acct_gst_tds_dtl where  logicalloc_cd = :logicalLocCd and section_cd = :sectionCd  and advice_no = (:adviceNo)::numeric";
