...
public interface GlTxnSqlQueries {
	...
	public static final String GET_TOTAL_DEBIT_BAL ="select sum(txn_amt ) from accounts.ecgc_acct_gl_txn_dtl eagtd where maingl_cd = :mainGlCd and subgl_cd = :subGlCd and dr_cr_flg='Dr' ;";
	
	public static final String GET_TOTAL_CREDIT_BAL ="select sum(txn_amt ) from accounts.ecgc_acct_gl_txn_dtl eagtd where maingl_cd = :mainGlCd and subgl_cd = :subGlCd and dr_cr_flg='Cr' ;";
	
	public static final String DELETE_GL_TXN_HDR_BY_GL_TXN_NO = "DELETE FROM accounts.ecgc_acct_gl_txn_hdr WHERE gl_txn_no=:gl_txn_no";
	
	public static final String DELETE_GL_TXN_DTL_BY_GL_TXN_NO = "DELETE FROM accounts.ecgc_acct_gl_txn_dtl WHERE gl_txn_no=:gl_txn_no";
	
	public static final String ADD_GL_BR_BAL_YR="INSERT INTO accounts.ecgc_acct_gl_br_bal_yr"
	...
	public static final String UPDATE_CURR_DR_BAL_YR= "UPDATE accounts.ecgc_acct_gl_br_bal_yr SET "
	...
	public static final String UPDATE_CURR_CR_BAL_YR= "UPDATE accounts.ecgc_acct_gl_br_bal_yr SET "
