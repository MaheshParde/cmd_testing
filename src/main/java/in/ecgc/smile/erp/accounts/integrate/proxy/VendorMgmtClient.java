...
@FeignClient(name = "erp-admin-vendor-mgmt-be", contextId = "AdminVendorClient", fallbackFactory = VendorMgmtClientFallback.class,configuration = FeignErrorDecoder.class)
